                        ...
                        <div class="row">
                          ...
                          <div class="col-md-4">
                            <div class="form-group has-feedback <?php echo  (form_error('photo') || isset($errors['photo'])) ? 'has-error' : ''; ?>">
                              <center>
                                <img alt="" class="img-thumbnail" id="display-photo" src=""/><br/>
                              </center>
                              <p class="help-block text-center"><i>Image type, Max. 20MB</i></p>
                              <div class="fileUpload btn btn-block">
                                  <input class="form-control upload" name="photo" onchange="readImg(this, '#display-photo');" type="file"  accept="image/*" />
                              </div>
