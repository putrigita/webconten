                    ...
                    <div class="modal-body">
                      <form action="<?php echo base_url().'category/add';?>" method="POST" enctype="multipart/form-data" accept-charset="utf-8" >
                        ...
                        <div class="form-group has-feedback <?php echo (form_error('chain_for') || isset($errors['chain_for'])) ? 'has-error' : ''; ?>">
                          ...
                          <input type="text" required="required" placeholder="News or Article" maxlenght="10" name="chain_for"  class="form-control"  />
                          <i class="fa fa-pencil form-control-feedback"></i>
