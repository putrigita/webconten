                    ...
                    <div class="modal-header">
                      ...
                      <h4 class="modal-title"><i class="fa fa-users"></i> <?php echo lang('create_group_heading');?></h4>
                    </div>
                    <div class="modal-body">
                      <form action="<?php echo base_url().'auth/create_group';?>" method="POST" enctype="multipart/form-data" accept-charset="utf-8" >
