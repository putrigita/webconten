          ...
          <div class="col-md-8">
            <div class="tim-container">
              <div class="tim-row" id="buttons-row">
                <p style="font-size:16px;color:#3c8dbc;margin-top:-80px;"><b><a href="<?php echo base_url()?>" ><?php echo $navbar_title_home; ?></a> / <a href="<?php echo base_url()?>news" ><?php echo $navbar_title_news; ?></a> / <a href="<?php echo base_url()?>news/categories/<?php echo $headline[0]['category_id']; ?>" ><?php echo $headline[0]['category_name']; ?></a> </b></p>
