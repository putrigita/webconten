          ...
          <div class="col-md-8">
            <div class="tim-container">
              <div class="tim-row" id="buttons-row">
                <p style="font-size:16px;color:#3c8dbc;margin-top:-80px;"><b><a href="<?php echo base_url()?>" ><?php echo $navbar_title_home; ?></a> / <a href="<?php echo base_url()?>article" ><?php echo $navbar_title_article; ?></a> / <a href="<?php echo base_url()?>article/categories/<?php echo $headline[0]['category_id']; ?>" ><?php echo $headline[0]['category_name']; ?></a> </b></p>

<?php if($headline[0] != NULL){ ?>                         
                <div class="news-content">
                  <a href="<?php echo base_url()?>article/category/<?php echo $headline[0]['article_slug']; ?>" style="text-decoration:none;">
                        <img src="<?php echo 'http://localhost/WebContent/Panel/assets/upload/article/'.$headline[0]['article_img'];?>" alt="Thumbnail Image" class="img-raised img-square" width="100%">
                        <div class="top-headline"><b><?php echo $headline_tags; ?></b></div>
                        <div class="bottom-headline">
                          <h3 style="margin-left:15px;"><?php echo $headline[0]['article_title']; ?></h3>
